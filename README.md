...
- Timestamp: `2022-06-22 06:53`
- Build ID: `3be75796-8854-4d2d-ac55-e53b1b2d8cea`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3be75796-8854-4d2d-ac55-e53b1b2d8cea.git
$ cd 3be75796-8854-4d2d-ac55-e53b1b2d8cea
```
